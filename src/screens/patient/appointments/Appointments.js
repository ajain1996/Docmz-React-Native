    ...
    <View
          ...
          <TouchableOpacity onPress={switchToTab0}>
            <Text
              style={{
                ...
                fontSize: 18,
                fontFamily:
                  tablocation === 0 ? 'Montserrat-Bold' : 'Montserrat-Regular',
              }}>
      ...
      <View style={{ flex: 1, backgroundColor: Colors.grey_background[theme] }}>
        {tablocation === 1 ? (
          ...
          <SectionList
            style={{ flex: 1, paddingHorizontal: '1%', marginBottom: "15%" }}
            ...
            renderSectionHeader={({ section: { title } }) => {
              return <Text style={{ ...styles.sectionHead, color: Colors.primary_text_color[theme] }}>{title}</Text>;
            }}
            onRefresh={fetchAppointments}
            refreshing={gettingAppointments || extractingAppointmentList}
            extraData={extraDataForTabs}
