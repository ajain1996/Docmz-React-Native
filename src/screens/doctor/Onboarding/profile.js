...
const MaterialIconsUse = ({ iconName, iconColor, iconSize }) => <MaterialCommunityIcons name={iconName} size={iconSize} color={iconColor} />
const FontAwesome5IconsUse = ({ iconName, iconColor, iconSize }) => <FontAwesome5Icons name={iconName} size={iconSize} color={iconColor} />
...
function Onboarding({ navigation }) {
  ...
  useEffect(() => {
    ...
    setAwards(userData?.awards ? userData?.awards : [{ name: '', year: '' }]);
    setConditions(
      userData?.conditions?.length > 0 ? userData?.conditions : [''],
    );
    setAddress(userData?.addresses?.length > 0 ? userData?.addresses : ['']);
    setEducation(
      userData?.education
        ? userData?.education
    ...
    <>
        ...
        <ScrollView style={OnboardingStyle.ScrollView}>
          {/* <View
            ...
            <Text
              ...
              Welcome to
              <Text style={{ color: '#37acac', fontWeight: 'bold' }}> DocPlus</Text>
            </Text>
            <Text
              style={{
                fontSize: 18,
          ...
          <View
            ...
            <TouchableOpacity
              style={OnboardingStyle.RowAlign}
              onPress={onPressSignature}>
              <Text style={{ marginRight: 6 }}><FontAwesome5IconsUse iconColor={Colors.primary_text_color[theme]} iconName="signature" iconSize={18} /></Text>
              <Text
                style={{
                  fontSize: 18,
                  fontWeight: 'bold',
          ...
          <View
            ...
            <TouchableOpacity style={OnboardingStyle.RowAlign} onPress={onPressSignatureL}>
              <Text style={{ marginRight: 6 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconSize={20} iconName="format-letter-ends-with" /></Text>
              <Text
                style={{
                  fontSize: 18,
                  fontWeight: 'bold',
          ...
          <View
            ...
            <TouchableOpacity style={OnboardingStyle.RowAlign} onPress={onPressSignatureV}>
              <Text style={{ marginRight: 8 }}><FontAwesome5IconsUse iconColor={Colors.primary_text_color[theme]} iconName="video" iconSize={15} /></Text>
              <Text
                style={{
                  fontSize: 18,
                  fontWeight: 'bold',
          ...
          <View
            style={{
              ...
              marginBottom: 14,
              paddingLeft: '4%',
              ...OnboardingStyle.RowAlign
            }}>
            <Text style={{ marginRight: 4 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="information-variant" iconSize={24} /></Text>
            <Text
              style={{
                fontSize: 18,
                fontWeight: 'bold',
          ...
          <View
            ...
            <Text style={{ marginRight: 8 }}><FontAwesome5IconsUse iconColor={Colors.primary_text_color[theme]} iconName="person-booth" iconSize={15} /></Text>
            <Text
              style={{
                fontSize: 18,
                fontWeight: 'bold',
          ...
          <View
            ...
            <Text style={{ marginRight: 8 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="cast-education" iconSize={18} /></Text>
            <Text
              style={{
                fontSize: 18,
                fontWeight: 'bold',
          ...
          <View
            ...
            <Text style={{ marginRight: 8 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="card-account-details-outline" iconSize={20} /></Text>
            <Text
              style={{
                fontSize: 18,
                fontWeight: 'bold',
          ...
          <View
            ...
            <Text style={{ marginRight: 8 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="account-cash" iconSize={20} /></Text>
          ...
          */}
          ...
          <View
            ...
            <Text style={{ marginRight: 6 }}><FontAwesome5IconsUse iconColor={Colors.primary_text_color[theme]} iconName="globe-asia" iconSize={18} /></Text>
            <Text
              style={{
                fontSize: 18,
                fontWeight: 'bold',
      ...
      /> */}
          ...
          <View
            ...
            <Text style={{ marginRight: 6 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="relation-only-one-to-many" iconSize={22} /></Text>
      ...
      /> */}
          ...
          <View
            ...
            <Text style={{ marginRight: 6 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="office-building" iconSize={20} /></Text>
      ...
      /> */}
          ...
          <View
            ...
            <Text style={{ marginRight: 8 }}><FontAwesome5IconsUse iconColor={Colors.primary_text_color[theme]} iconName="award" iconSize={18} /></Text>
          ...
          <View
            ...
            <Text style={{ marginRight: 6 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="apple-keyboard-option" iconSize={18} /></Text>
          ...
          <View
            ...
            <Text style={{ marginRight: 6 }}><MaterialIconsUse iconColor={Colors.primary_text_color[theme]} iconName="pickaxe" iconSize={18} /></Text>
            ...
            {followUps === 'Yes' && (
              <View
                ...
                <TextInput
                  ...
                  keyboardType={'number-pad'}
                  placeholder={`How many free follow ups would you like to allow?`}
                  placeholderTextColor={Colors.input_placeholder_color[theme]}
                />
              </View>
            )}
