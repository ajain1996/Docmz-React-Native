...
export const GetAvailableMedicines = (search, sucess = () => { }) => (
  dispatch,
) => {
  const config = {
    'Content-Type': 'application/x-www-form-urlencoded',
...
export const AddMedicine = (data, success = () => { }) => (dispatch) => {
  //data:{metaId,medicines}
  const config = {
    'Content-Type': 'application/x-www-form-urlencoded',
  };
...
export const EditMedicine = (data, success = () => { }) => (dispatch) => {
  //data:{metaId,medicines}
  const config = {
    'Content-Type': 'application/x-www-form-urlencoded',
  };
...
export const DeleteMedicine = (data, meta, success = () => { }) => (
  dispatch,
) => {
  //data:{metaId,medicines}
  const config = {
...
export const AddPrescription = (data, cb = () => { }) => (dispatch) => {
  //data:{metaId,medicines}
  //dispatch(startLoading())
  const config = {
    'Content-Type': 'application/x-www-form-urlencoded',
...
export const UploadRecords = (fileData, success = () => { }, error = () => { }) => {
  return (dispatch) => {
