  ...
  return (
    <View
      style={[
        ...
        {/* {console.log(`${Host}${data?.picture[0]?.replace('public', '')?.replace('\\\\', '/')}`, "sdklfjsdklfjskldfj")} */}
      ...
      <AvailDoctorContentV2
        ...
        Profile={
          data?.picture?.length ? <ProfilePic
          sourceurl={
        ...
        /> : <PicturelessAvatar style={{color: "#000",backgroundColor: '#f9f9f9', height: 65, width: 65, borderRadius: 60,}} text={`${name?.split(" ")[0][0]}${name?.split(" ")[1][0]}`}/>
        }
        />
